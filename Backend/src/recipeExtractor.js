...
const SYSTEM_PROMPT = [
  ...
  "If the source does not provide explicit headers but the recipe clearly has distinct components, infer sensible ingredient group headers yourself.",
  "For example, if a recipe describes ingredients for chicken, vegetables, and a sauce in separate parts of the instructions, you may return headers like 'Chicken:', 'Vegetables:', and 'Sauce:'.",
  "Only use a section header when it groups multiple following ingredients.",
  "Never output a single ingredient such as 'Salt', 'Black pepper', 'Olive oil', or 'Broccoli florets' as a section header.",
  "If a line is an ingredient, keep it as a normal ingredient line, not a header.",
...
function buildUserPrompt(payload) {
  ...
  return [
    ...
    "- If the source has no explicit headers but the recipe clearly contains separate components, infer clear group headers yourself, such as 'Chicken:', 'Vegetables:', 'Marinade:', or 'Sauce:'.",
    "- Only use a section header if it groups multiple following ingredients.",
    "- Never turn a single ingredient line like 'Salt', 'Black pepper', 'Olive oil', or 'Broccoli florets' into a section header.",
