            ...
            ZStack {
                ...
                VStack(alignment: .leading, spacing: 24) {
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        Text("Sign in with Apple to create or join a shared household cookbook. Everyone in the household can add, edit, and save recipes together in real time.")
                            .font(.system(size: 15, weight: .medium, design: .rounded))
                            .foregroundStyle(.secondary)
                    }

                    VStack(alignment: .leading, spacing: 12) {
                        featureRow(icon: "person.2.fill", text: "Share the same recipe collection with your household.")
                    ...
                    Text(environment.mode == .firebase
                         ? "After signing in, you can create a household or join one with an invite code."
                         : "Demo mode signs you into the shared sample household automatically.")
